...
Arquitectura Híbrida (CNN-12 + GRU) - Clasificación Binaria 
=============================================================================
"""
...
def build_complete_sleep_model_binario(n_sequences, insize_per_ep, nunit=64, dropout_rnn=0.3, num_clases=NUM_CLASES):
    ...
    # Se instancia el extractor de características base (CNN) y se envuelve la CNN en una capa TimeDistributed para procesar la secuencia temporal completa
